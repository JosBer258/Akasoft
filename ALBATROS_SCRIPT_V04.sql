USE [master]
GO
/****** Object:  Database [ALBATROS]    Script Date: 7/3/2022 3:40:47 PM ******/
...
USE [ALBATROS]
GO
/****** Object:  Table [dbo].[CLIENTES]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[FACTURA_DETAIL]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FACTURA_HEADER]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IMPUESTO]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PRODUCTO]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ALBATROS_CLIENTE_DELETE]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ALBATROS_CLIENTE_UPDATE]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ALBATROS_CLIENTES]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END 
GO
/****** Object:  StoredProcedure [dbo].[ALBATROS_FACTURA_DETAIL]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/***************************************/
	INSERT INTO [dbo].[FACTURA_DETAIL]
           ([ID_FACTURA]
           ,[CODIGO_PRODUCTO]
           ,[CANTIDAD]
           ,[PRECIO]
...
GO
/****** Object:  StoredProcedure [dbo].[ALBATROS_FACTURA_HEADER_UPDATE]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ALBATROS_FACTURACION_HEADER]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/***************************************/
INSERT INTO ALTABATROS.[dbo].[FACTURA_HEADER]
           ([ID_CLIENTE]
           ,[TOTAL_IMPUESTO]
           ,[TOTAL_FACTURA]
           ,[FECHA_ANULACION])
...
GO
/****** Object:  StoredProcedure [dbo].[ALBATROS_PRODUCTOS]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ALBATROS_PRODUCTOS_DELETE]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ALBATROS_PRODUCTOS_UPDATE]    Script Date: 7/3/2022 3:40:48 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
